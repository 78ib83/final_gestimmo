            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="bg-gradient-to-r from-gray-100 to-indigo-100 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <div class="">
                            <h3 class="">
                                Mise à jour de {{ contrat.code }} {{ contrat.type }}
                            </h3>
                            <form @submit.prevent="valider" id="editContForm">
                                <div class="">
                                    <div class="mb-5">
                                        <label for="type"
                            ...
                            <button form="editContForm" type="submit"
...
const formCont = useForm({
    type: props.contrat.type,
    libelle: props.contrat.libelle,
    duree: props.contrat.duree,
})

const valider = () => {

    formCont.put(`/contrats/${props.contrat.id}`, {
        onSuccess: (page) => {
            //useSawalSuccess("Propriété ajouté avec succès.")
            alert("Contrat mise à jour avec succès ! ")
            /*formProp.reset()
            inputKey.value = null
