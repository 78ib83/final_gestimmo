        ...
        <div class="py-2">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody v-for="payment in props.payments.data" :key="payment">
                        <tr class=" border-b dark:border-gray-300">
                            ...
                            <td class="px-6 py-4">
                                <Link @click="deletePay(payment.id)"
                ...
                <Pagination :links="props.payments.links" :prev="props.payments.prev_page_url"
...
import CreatePay from './CreatePay.vue';
