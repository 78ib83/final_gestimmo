        ...
        <div class="py-2">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody v-for="maintenance in props.maintenances.data" :key="maintenance">
                        <tr class=" border-b dark:border-gray-300">
                            ...
                            <td class="px-6 py-4 font-semibold text-gray-900 dark:text-gray-500">
                                {{ maintenance.datemaint }}
                            </td>
                            <td class="px-6 py-4">
                                <Link @click="deleteMaint(maintenance.id)"
                ...
                <Pagination :links="props.maintenances.links" :prev="props.maintenances.prev_page_url"
                    :next="props.maintenances.next_page_url" />
            </div>
        </div>
    </AuthenticatedLayout>
</template>
...
import CreateMaint from './CreateMaint.vue';
...
const deleteMaint = (id) => {
    form.delete(`maintenances/${id}`);
};
